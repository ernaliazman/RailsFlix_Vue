          ...
          <div class="md:max-w-md w-full px-4 py-4 bg-gray-50 ml-auto">
            <form>
              <div class="mb-12">
                ...
                <p class="text-sm mt-4 text-gray-800">Already have an account? <a 
                    href="javascript:void(0);" @click="switchToSignIn" class="text-green-600 font-semibold hover:underline ml-1 whitespace-nowrap">Sign In</a></p>
              </div>
              ...
              <div class="mt-12">
                <button type="button" class="w-full shadow-xl py-2.5 px-4 text-sm tracking-wide rounded-md text-white bg-[#A93428] hover:bg-gray-700 focus:outline-none">
                  Sign in
                </button>
              </div>
